...
# 232 "/usr/local/cuda/bin/../include/crt/device_runtime.h" 3
...
struct
       ...
       __attribute__((__aligned__(2*sizeof(long int))))
...
struct
       ...
       __attribute__((__aligned__(2*sizeof(unsigned long int))))
...
# 45 "/usr/local/cuda/bin/../include/builtin_types.h" 2 3
# 233 "/usr/local/cuda/bin/../include/crt/device_runtime.h" 2 3
# 1 "/usr/local/cuda/bin/../include/device_launch_parameters.h" 1 3
# 39 "/usr/local/cuda/bin/../include/device_launch_parameters.h" 3
# 1 "/usr/local/cuda/bin/../include/vector_types.h" 1 3
# 40 "/usr/local/cuda/bin/../include/device_launch_parameters.h" 2 3
# 53 "/usr/local/cuda/bin/../include/device_launch_parameters.h" 3
struct uint3 extern const threadIdx;

struct uint3 extern const blockIdx;

struct dim3 extern const blockDim;

struct dim3 extern const gridDim;

int extern const warpSize;
# 234 "/usr/local/cuda/bin/../include/crt/device_runtime.h" 2 3
# 1 "/usr/local/cuda/bin/../include/crt/storage_class.h" 1 3
# 234 "/usr/local/cuda/bin/../include/crt/device_runtime.h" 2 3
# 217 "/usr/lib/gcc/i686-apple-darwin9/4.0.1/include/stddef.h" 2 3
# 115 "/usr/include/i386/_types.h" 3
typedef unsigned long __darwin_clock_t;
# 77 "/usr/include/time.h" 3
typedef __darwin_clock_t clock_t;
# 3 "14.cu"
__attribute__((__global__)) extern void _Z6kernelPi(int *const);
...
static int __cuda_error_not_implememted(void);
...
# 1340 "/usr/local/cuda/bin/../include/device_functions.h" 3
...
# 1615 "/usr/local/cuda/bin/../include/device_functions.h" 3
    if ((((xx << 1) == 0) && ((yy << 1) == 0xff000000)) ||
        (((yy << 1) == 0) && ((xx << 1) == 0xff000000))) {
      return rsqrtf(__int_as_float(0xffc00000));
    }
...
# 1879 "/usr/local/cuda/bin/../include/device_functions.h" 3
    if ((((xx << 1) == 0) && ((yy << 1) == 0xff000000)) ||
        (((yy << 1) == 0) && ((xx << 1) == 0xff000000))) {
      return rsqrtf(__int_as_float(0xffc00000));
    }
...
# 2148 "/usr/local/cuda/bin/../include/device_functions.h" 3
    if ((((xx << 1) == 0) && ((yy << 1) == 0xff000000)) ||
        (((yy << 1) == 0) && ((xx << 1) == 0xff000000))) {
      return rsqrtf(__int_as_float(0xffc00000));
    }
...
static float __fdividef(float a, float b)
{
  ...
  return a / b;
# 4591 "/usr/local/cuda/bin/../include/device_functions.h" 3
}
...
# 597 "/usr/local/cuda/bin/../include/sm_13_double_functions.h" 3
...
# 1442 "/usr/local/cuda/bin/../include/math_functions.h" 3
  expo -= 127;
...
# 2581 "/usr/local/cuda/bin/../include/math_functions.h" 3
...
# 2628 "/usr/local/cuda/bin/../include/math_functions.h" 3
    float scaled_b = __int_as_float ((__float_as_int(b) & 0x007fffff) |
                                     (__float_as_int(a) & 0x7f800000));
    if (scaled_b > a) {
      scaled_b *= 0.5f;
...
# 2656 "/usr/local/cuda/bin/../include/math_functions.h" 3
...
# 2707 "/usr/local/cuda/bin/../include/math_functions.h" 3
    float scaled_b = __int_as_float ((__float_as_int(b) & 0x007fffff) |
                                     (__float_as_int(a) & 0x7f800000));
    if (scaled_b > a) {
      scaled_b *= 0.5f;
...
# 2742 "/usr/local/cuda/bin/../include/math_functions.h" 3
  if (a >= 1.175494351e-38f) {
    twoa = 2.0f * a;
...
{
# 3042 "/usr/local/cuda/bin/../include/math_functions.h" 3
...
# 6 "14.cu" 2
# 3 "14.cu"
__attribute__((__global__)) void _Z6kernelPi(
# 3 "14.cu"
__attribute__((__shared__)) int *const a){
# 3 "14.cu"
{
# 3 "14.cu"
{
